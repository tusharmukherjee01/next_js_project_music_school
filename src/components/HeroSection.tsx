  ...
  return (
    ...
    >
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        > Dive into comprehensive courses on music courses and transform your journey today.Weather you are a beginner or a looking to refine your skills, we have the perfect course for you</p>
        <div className="mt-4">
            <Link href={"/courses"} >
            <Button
